 ...
 * Generated at: 2018-03-23 06:53:52 UTC
...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
      ...
      out.write("\t//删除部门\r\n");
      out.write("\tfunction delete_dept(){\r\n");
      out.write("\t\tvar row = $(\"#deptTable\").datagrid(\"getSelected\");\r\n");
      out.write("\t\tif (row == null) {\r\n");
      out.write("\t\t\talert(\"请选择部门!\");\r\n");
      out.write("\t\t\treturn;\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\tif (row.children.length > 0) {\r\n");
      out.write("\t\t\talert(\"该部门还有子部门不能删除！\");\r\n");
      out.write("\t\t\treturn;\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t$.messager.confirm(\"提示\",\"确定要删除么？\",function (r){\r\n");
      out.write("\t\t\tif (r) {\r\n");
      out.write("\t\t\t\t$.post(\"dept/delete\",{id:row.id},function (data){\r\n");
      out.write("\t\t\t\t\tif (data.result) {\r\n");
      out.write("\t\t\t\t\t\talert(\"删除成功！\");\r\n");
      out.write("\t\t\t\t\t\t$(\"#deptTable\").treegrid(\"reload\");\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t})\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t}\r\n");
      ...
      out.write("\t\t\thref:'dept/form',\r\n");
      out.write("\t\t\twidth:500,\r\n");
      out.write("\t\t\theight:'auto',\r\n");
      out.write("\t\t\tmodal:true,\r\n");
      out.write("\t\t\tonClose:function (){$(this).dialog(\"destroy\");},\r\n");
      out.write("\t\t\tonLoad:function (){\r\n");
      out.write("\t\t\t\t$.post(\"dept/getById\",{id:row.id},function (data){\r\n");
      ...
      out.write("\t\t\t\t\t$(\"#deptForm\").form(\"load\",data); \r\n");
      out.write("\t\t\t\t}) \r\n");
      out.write("\t\t\t},\r\n");
      out.write("\t\t\tbuttons:[{\r\n");
      ...
      out.write("\t\t\t\t\t$(\"#deptForm\").form(\"submit\",{\r\n");
      out.write("\t\t\t\t\t\turl:'dept/update',\r\n");
      ...
      out.write("</head>\r\n");
      out.write("<body>\r\n");
      out.write("\t<table id=\"deptTable\"  title=\"dept List\"\r\n");
      out.write("        data-options=\"url:'dept/list',fitColumns:true,striped:true,iconCls:'icon-search'\">\r\n");
      out.write("    <thead>\r\n");
      out.write("        <tr> \r\n");
      out.write("            <th data-options=\"field:'text',width:100,sortable:true\">部门名称</th>\r\n");
      out.write("\t\t\t<th data-options=\"field:'deptPrincipal',width:50\">部门负责人</th>\r\n");
      out.write("            <th data-options=\"field:'deptPhone',width:100\">部门电话</th>\r\n");
      out.write("            <th data-options=\"field:'deptFax',width:100\">部门传真</th>\r\n");
      out.write("           \t<th data-options=\"field:'remark',width:150\">备注</th> \r\n");
      out.write("        </tr>\r\n");
      out.write("    </thead>\r\n");
      out.write("</table>\r\n");
      out.write("<div id=\"tb\">\r\n");
      out.write("<a href=\"javascript:void(0)\" class=\"easyui-linkbutton\" onclick=\"add_dept();\" data-options=\"iconCls:'icon-add',plain:true\">添加</a>\r\n");
      out.write("<a href=\"javascript:void(0)\" class=\"easyui-linkbutton\" onclick=\"edit_dept();\" data-options=\"iconCls:'icon-edit',plain:true\">修改</a>\r\n");
      out.write("<a href=\"javascript:void(0)\" class=\"easyui-linkbutton\" onclick=\"delete_dept();\" data-options=\"iconCls:'icon-remove',plain:true\">删除</a>\r\n");
      out.write("</div>\r\n");
      out.write("</body>\r\n");
      out.write("</html>");
